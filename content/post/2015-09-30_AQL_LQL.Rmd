...
What is SSPDesignBinomial doing under the hood? I unpacked the SSPDesignBinomial code to pull out record each iteration and plot it. Below I show the OC curve as the algorithm iterates. 
...
If you watch closely, you can see what's going on. $n$ increases until the OC curve drops below $\beta$ at the LQL. Then, if the OC curve has dropped below $1-\alpha$ at the AQL, the acceptance criteria is increased. Below is the code used to generate the animated plot.
